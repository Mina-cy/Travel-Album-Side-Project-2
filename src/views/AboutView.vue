            ...
            <section class="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center ">
                ...
                <div class="lg:col-span-6 flex flex-col justify-center gap-4 xl:gap-6 pl-2 xl:pl-16">
                    ...
                    <AboutText>
                        ...
                        <template #paragraph1>
                            我以 100% 的作業完成率，堅持每天都練習撰寫CODE，從零開始系統性地掌握了前端開發的核心技能：
                        </template>

                        <template #paragraph2>
                            扎實的基礎建設：從 HTML5 語意化結構、CSS3與RWD起步，打下穩固的切版基礎。<br>
                            <p class="text-black">動態邏輯與框架應用：深入學習 JavaScript核心語法、DOM 操作與非同步處理，並能運用 Vue.js 3 框架進行元件化開發。<br></p>
                            <p class="text-black">完整協作與發佈流程：熟悉 Git 版本控制、GitHub 團隊協作流程，並使用 Vite 進行專案建置，完成從開發到部署的標準實務。</p>
                        </template>
                    </AboutText>
                </div>
            </section>
